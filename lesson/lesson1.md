...
- Реализуйте методы `save, get, delete, clear, getAll, size` в классе `com.topjava.webapp.storage.ArrayStorage`, организовав хранение резюме в массиве 
...
1. Не меняйте сигнатуры методов в `com.topjava.webapp.storage.ArrayStorage`
